      ...
      <div class="container"><a class="navbar-brand d-inline-flex" href="{{ route('app-home') }}"><img class="d-inline-block logo-brand" src="../../resources/images/logo.png" alt="logo" /><span class="text-1000 fs-3 fw-bold ms-2 text-gradient">GoMarket</span></a>
        ...
        <form>
          <div class="input-group-icon pe-2">
            <span class="material-icons input-box-icon">search</span>
        ...
        <div class="collapse navbar-collapse border-top border-lg-0 my-2 mt-lg-0" id="navbarSupportedContent">
          ...
          <button class="btn btn-primary badge-notification badge rounded-pill">
            ...
            @else
            <a href="{{ route('app-login') }}" class="btn btn-white shadow-warning text-warning btn-login" type="button">
                  ...
                  <div class="row justify-content-center">
                    ...
                    <div class="col-md-7 col-xl-5 col-xxl-4 p-4 p-lg-5">
                      <div class="">
                        ...
                        <form action="{{ route('app-login') }}" method="post" class="mt-3">
                            @csrf
                        ...
                        <p class="text-center mt-5" style="font-size: 14px">Bạn chưa có tài khoản? <a style="color:cadetblue" href="{{ route('app-register') }}">Đăng ký ngay</a></p>
                      </div>
                    </div>
                  </div>
                </div>
